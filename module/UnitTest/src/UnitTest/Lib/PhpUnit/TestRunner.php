<?php
namespace UnitTest\Lib\PHPUnit;
 ...
 */
class TestRunner extends \PHPUnit_Runner_BaseTestRunner
{
    ...
    public function doRun(\PHPUnit_Framework_Test $suite, array $arguments = array())
    {
        ...
        if (isset($arguments['bootstrap'])) {
            $GLOBALS['__\PHPUnit_BOOTSTRAP'] = $arguments['bootstrap'];
        }
    ...
    /**
     * @param  \PHPUnit_Util_Printer $resultPrinter
     */
    public function setPrinter(\PHPUnit_Util_Printer $resultPrinter)
    {
